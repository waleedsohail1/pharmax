          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-10">
                    <h1 class="">Sales Purchase Officer
                      <br> </h1>
                  </div>
                ...
                <div class="table-responsive border">
                  <table class="table">
                    <thead class=" text-primary">
                      <tr>
                        <th class="border text-center">SPO ID</th>
                    ...
                    <?php
                     if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                        ...
                        echo  "<td class='text-center'>". $row["SPOID"]."<td class='text-center'>". $row["SPOName"]."<td class='text-center'>". $row["Age"]."<td class='text-center'>". $row["Area"]."<td class='text-center'>".$row["City"]. '<td class="text-center"><a href="EditSPO.php?SPOID='. $row["SPOID"].'"><img src="../pix/pencil.png" width="25px"></a><td class="text-center"><a href="deleteSPO.php?SPOID='. $row["SPOID"].'"><img src="../pix/trash.png" width="25px"></a></td>'. "</tr>";
                      }
                    } else {
                      echo "0 results";
                    }
